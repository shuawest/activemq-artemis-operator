...
var (
	...
	container   = containers.MakeContainer(namespacedName.Name, "quay.io/shuawest/activemq-artemis-operator:latest", environments.MakeEnvVarArrayForCR(&AMQinstance))
